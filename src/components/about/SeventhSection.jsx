...
function SeventhSection() {
    ...
    return (
        <div
            className="h-auto md:flex md:h-[300vh] object-cover px-5 md:px-0"
            style={{
                backgroundImage:
                    'linear-gradient(to bottom, rgba(15, 13, 26, 0.8) 65%, #0f0d1a), url(https://cdn.prod.website-files.com/650c51b8e8548a72ca6aba04/6515539f331a3329d9005b5d_refargotohp-x8dTKZ5IWp0-unsplash.webp)',
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        'url(https://cdn.prod.website-files.com/650c51b8e8548a72ca6aba04/6516dfb9da737c2b1a589700_tim-stief-dH6IjhWHNQQ-unsplash.webp)',
                    backgroundAttachment: 'fixed',
                    objectPosition: 'top',
                    objectFit: 'cover',
                }}
