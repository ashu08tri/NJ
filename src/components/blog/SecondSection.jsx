...
function SecondSection() {
  return (
    <div id='blog' className='bg-[#e4cecc] text-[#e4938a] py-16 px-8 md:px-20'>
      ...
      <div className='flex flex-col gap-10'>
        <div className='relative overflow-hidden w-full h-[60vh] md:h-[55vh] border-[2px] border-[#4c2e2b]'>
          ...
          <img loading="lazy" src="https://cdn.prod.website-files.com/650c51b8e8548a72ca6ab9d9/651d6de3173724960aef55a5_pexels-karolina-grabowska-4386174.jpg" alt="secondSection_img1" className='w-full h-full object-cover'/>
        ...
        <div className='absolute inset-0 h-full bg-purpleNoBlur mix-blend-multiply'/>
        <img loading="lazy" src="https://cdn.prod.website-files.com/650c51b8e8548a72ca6ab9d9/651d6e042c83a9c85b7eea8c_viktor-forgacs-md1SZCindxE-unsplash.jpg" alt="secondSection_img2" className='w-full h-full object-cover'/>
          <SlideReveal bgColor={'#4c2e2b'}/>
        ...
        <div className='relative overflow-hidden w-full h-[60vh] border-[2px] border-[#4c2e2b]'>
        <div className='absolute inset-0 h-full bg-purpleNoBlur mix-blend-multiply'/>
        <img loading="lazy" src="https://cdn.prod.website-files.com/650c51b8e8548a72ca6ab9d9/651d6dd586296e439a96c43d_pat-whelen-61pYLHurVKE-unsplash.jpg" alt="secondSection_img3" className='w-full h-full object-cover'/>
          <SlideReveal bgColor={'#4c2e2b'}/>
          ...
          <p className='text-3xl md:text-4xl font-medium text-[#cc7b72] md:w-5/12 hover:text-[#e4938a] border-l pl-6 border-[#cc7b72]
            hover:border-[#e4938a] hover:pl-8 cursor-pointer transition-all duration-100 
          '>Navigating the Volatile Markets: A Comprihensive Guide</p>
           </div>

          <div className='md:flex justify-between'>
            <p className='md:w-4/12'>Explore practical tips for safeguarding your investments during market fluctuations. Stay resilient and thrive.</p>
            <div className='md:w-64 py-4' style={{color: '#e4938a'}}>
              <HoverText text={'Read the Article'} overlayBG={'#4c2e2b'} mainBG={'rgba(204, 123, 114, 0.5)'} borderColor={'rgba(230, 148, 140, .5)'}/>
            </div>
          </div>
