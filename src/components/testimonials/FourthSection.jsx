...
function FourthSection() {
  ...
  return (
    <div className='relative overflow-hidden h-[95vh] bg-[#262140]'>
      <ParallaxImage src={"https://cdn.prod.website-files.com/650c51b8e8548a72ca6aba04/65240790bea7372ec0aba88e_adeolu-eletu-dgOJDAv96s8-unsplash.webp"} alt={"thirdSection_img"}
       scrollNum={50} delay={1} height={'180%'} />
