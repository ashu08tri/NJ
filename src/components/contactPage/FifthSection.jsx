...
function FifthSection() {
  ...
  return (
    <div className='relative overflow-hidden h-[95vh] bg-[#262140]'>
      <ParallaxImage src={"https://cdn.prod.website-files.com/650c51b8e8548a72ca6aba04/65240790c0ef8b47857936a8_alvin-mahmudov-oBT4lJvNMQg-unsplash.webp"} alt={"thirdSection_img"}
