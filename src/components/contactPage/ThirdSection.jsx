...
function ThirdSection() {
    return (
        <div className='bg-[#1e1a33] py-12 md:py-20 px-6 md:px-12 text-[#f8b3ac]'>
            <div>
                <p className='uppercase pb-8'>The Form</p>
                <p className='text-3xl md:text-5xl pb-12 md:w-1/2'>Secure Your Financial Well-being <span className='opacity-75'>Through Expert Consultation</span></p>
                <form>
                    ...
                    <div className='border-b border-brown15Text flex items-center md:hover:py-2 transition-all duration-75 ease-in'>
                        <label htmlFor="intrests" className='md:w-1/12 opacity-80'>Intrestes</label>
                        <input type="text" className='ml-4 md:m-0 md:w-11/12 py-6 bg-transparent focus:outline-none text-xl placeholder-brown9HoverBox' placeholder='Tax Strategies Consultation' required />
                        <span className='hidden md:block'>Required</span>
                    </div>
                    <div className='border-b border-brown15Text flex items-center md:hover:py-2 transition-all duration-75 ease-in'>
                        <label htmlFor="industry" className='md:w-1/12 opacity-80'>Industry</label>
                        <input type="text" className='ml-4 md:m-0 md:w-11/12 py-6 bg-transparent focus:outline-none text-xl placeholder-brown9HoverBox' placeholder='Education'/>
                    </div>
                    <div className='border-b border-brown15Text flex md:hover:py-2 transition-all duration-75 ease-in'>
                        <label htmlFor="name" className='md:w-1/12 opacity-80 pt-6'>Message</label>
